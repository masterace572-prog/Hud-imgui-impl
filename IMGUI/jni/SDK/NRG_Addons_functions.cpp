...
// Function Addons.OBHttpComponent.ClientGetPlayersAMInfo
// ()
// Parameters:
// TArray<struct FPlayerAMInfo>   PlayersAMInfo                  (ConstParm, Parm, ZeroConstructor, ReferenceParm)

void UOBHttpComponent::ClientGetPlayersAMInfo(TArray<struct FPlayerAMInfo> PlayersAMInfo)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Addons.OBHttpComponent.ClientGetPlayersAMInfo");

	UOBHttpComponent_ClientGetPlayersAMInfo_Params params;
	params.PlayersAMInfo = PlayersAMInfo;
...
// Function Addons.OBHttpComponent.ClientGetKillInfo
// ()
// Parameters:
// struct FPlayerKillInfoForPCOB  KillInfo                       (ConstParm, Parm, ReferenceParm)

void UOBHttpComponent::ClientGetKillInfo(const struct FPlayerKillInfoForPCOB& KillInfo)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Addons.OBHttpComponent.ClientGetKillInfo");

	UOBHttpComponent_ClientGetKillInfo_Params params;
...
// Function Addons.ObserverProbeComponent.OnCollectPlayersAMInfoForPCOB
// ()

void UObserverProbeComponent::OnCollectPlayersAMInfoForPCOB()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Addons.ObserverProbeComponent.OnCollectPlayersAMInfoForPCOB");

	UObserverProbeComponent_OnCollectPlayersAMInfoForPCOB_Params params;
