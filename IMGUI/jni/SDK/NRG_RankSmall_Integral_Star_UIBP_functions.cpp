...
// (NetReliable, Exec, Event, MulticastDelegate, Public, Protected, HasOutParms, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
void URankSmall_Integral_Star_UIBP_C::SetRankIntegral(const struct FBP_STRUCT_RankIntegralLevel_type& RankIntegralLevel_Info, bool isStarOpen)
{
...
// (NetReliable, NetRequest, Exec, Native, MulticastDelegate, Public, Protected, HasOutParms, DLLImport, BlueprintEvent, Const, NetValidate)
// Parameters:
...
// (NetReliable, NetRequest, Static, MulticastDelegate, Private, NetServer, NetClient, DLLImport)
// Parameters:
