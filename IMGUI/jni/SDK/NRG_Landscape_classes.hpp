...
public:
	...
	unsigned char                                      UnknownData14[0x5];                                       // 0x07B3(0x0005) MISSED OFFSET
...
public:
	...
	struct FBoxSphereBounds                            LocalBounds;                                              // 0x07A8(0x001C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x07C4(0x000C) MISSED OFFSET
...
{
public:
	int                                                SectionBaseX;                                             // 0x0770(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x0774(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                ComponentSizeQuads;                                       // 0x0778(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x077C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x0780(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0784(0x0004) MISSED OFFSET
	class UMaterialInterface*                          OverrideMaterial;                                         // 0x0788(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OverrideHoleMaterial;                                     // 0x0790(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FName, class UMaterialInterface*>      OverrideOtherMaterials;                                   // 0x0798(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	struct FOverridePhyxMaterial                       OverridePhyxMaterial;                                     // 0x07E8(0x0020) (Edit)
	unsigned char                                      bOverrideGrassTypes : 1;                                  // 0x0808(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0809(0x0007) MISSED OFFSET
	TArray<class ULandscapeGrassType*>                 GrassTypes;                                               // 0x0810(0x0010) (Edit, ZeroConstructor)
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                        // 0x0820(0x0010) (ZeroConstructor)
	TMap<struct FName, class UMaterialInstanceConstant*> OtherMaterialInstances;                                   // 0x0830(0x0050) (ZeroConstructor)
	...
	int                                                VisibilityLayerChannel;                                   // 0x08A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x08A4(0x0004) MISSED OFFSET
	class UTexture2D*                                  XYOffsetmapTexture;                                       // 0x08A8(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0xC];                                       // 0x08C4(0x000C) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x09C0(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData08[0x68];                                      // 0x0AA8(0x0068) MISSED OFFSET
	bool                                               bHasROCData;                                              // 0x0B10(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x17];                                      // 0x0B11(0x0017) MISSED OFFSET
	struct FName                                       UsedOtherMaterialName;                                    // 0x0B28(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x20];                                      // 0x0B30(0x0020) MISSED OFFSET
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                      // 0x0770(0x0010) (ZeroConstructor)
	int                                                SectionBaseX;                                             // 0x0780(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x0784(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CollisionSizeQuads;                                       // 0x0788(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionScale;                                           // 0x078C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionSizeQuads;                                 // 0x0790(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0794(0x0004) MISSED OFFSET
	TArray<unsigned char>                              CollisionQuadFlags;                                       // 0x0798(0x0010) (ZeroConstructor)
	struct FGuid                                       HeightfieldGuid;                                          // 0x07A8(0x0010) (IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                           // 0x07B8(0x001C) (IsPlainOldData)
	TLazyObjectPtr<class ULandscapeComponent>          RenderComponent;                                          // 0x07D4(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x07F0(0x0010) MISSED OFFSET
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                  // 0x0800(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x40];                                      // 0x0810(0x0040) MISSED OFFSET
...
{
public:
	struct FGuid                                       MeshGuid;                                                 // 0x0850(0x0010) (IsPlainOldData)
...
{
public:
	struct FGuid                                       LandscapeGuid;                                            // 0x0900(0x0010) (IsPlainOldData)
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x0910(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0920(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0921(0x000F) MISSED OFFSET
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                            // 0x0770(0x0010) (ZeroConstructor)
	TArray<class ULandscapeSplineSegment*>             Segments;                                                 // 0x0780(0x0010) (ZeroConstructor)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                              // 0x0790(0x0010) (ExportObject, ZeroConstructor)
