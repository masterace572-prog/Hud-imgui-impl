...
public:
	...
	void STATIC_ServerListClick();
	void STATIC_HasCloseLocation(bool UID, bool* Has);
	void STATIC_SetCloseLocation(bool CloseLocation, const struct FString& UID);
	...
	void STATIC_AcceptGuestWarning();
	void STATIC_RejectPolicy();
	void AcceptPolicy(int newVersion);
	void STATIC_SetFirstInLobby();
	void SetTime(int arg);
	void ClearCount();
	void SetCount(int Count);
	class USaveGame* STATIC_LoadData();
	void STATIC_SaveData(bool* SaveDataState);
};
