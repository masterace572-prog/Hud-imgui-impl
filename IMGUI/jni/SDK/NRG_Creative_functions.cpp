...
// Function Creative.CreativeModeBlueprintLibrary.GetBoundingBoxOfActorsNew
// ()
// Parameters:
// class UObject*                 WorldContextObject             (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
void UCreativeModeBlueprintLibrary::GetBoundingBoxOfActorsNew(class UObject* WorldContextObject, TArray<struct FString> InstanceIDs, float Yaw, struct FVector* Center, struct FVector* BoxExtent)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeModeBlueprintLibrary.GetBoundingBoxOfActorsNew");

	UCreativeModeBlueprintLibrary_GetBoundingBoxOfActorsNew_Params params;
	params.WorldContextObject = WorldContextObject;
...
void UCreativeModeBlueprintLibrary::AttachInstanceOutlineBox(const struct FString& AttachedId, float Yaw, class AActor* OutlineBox)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UCreativeModeBlueprintLibrary::AttachGroupInstanceOutlineBox(const struct FString& GroupID, TArray<struct FString> ChildrenIds, float Yaw, class AActor* OutlineBox)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UCreativeGameParameterManager::OnReceivePostGameParameterChange(const struct FString& ParameterKey, const struct FString& TemplateID, const struct FString& Desc)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UCreativeGameParameterManager::OnReceivePostGameParameterAdd(const struct FString& ParameterKey, const struct FString& TemplateID, const struct FString& Desc)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// Function Creative.CreativeGameParameterManager.GetGameParameterDesc
// ()
// Parameters:
// struct FString                 ParameterKey                   (Parm, ZeroConstructor)
// struct FString                 TemplateID                     (ConstParm, Parm, ZeroConstructor)
...
struct FString UCreativeGameParameterManager::GetGameParameterDesc(const struct FString& ParameterKey, const struct FString& TemplateID)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Creative.CreativeGameParameterManager.GetGameParameterDesc");

	UCreativeGameParameterManager_GetGameParameterDesc_Params params;
	params.ParameterKey = ParameterKey;
	params.TemplateID = TemplateID;
...
void UCreativeGameParameterManager::ChangeGameParameter(const struct FString& ParameterKey, const struct FString& TemplateID, const struct FString& Desc)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UCreativeGameParameterManager::AddGameParameter(const struct FString& ParameterKey, const struct FString& TemplateID, const struct FString& Desc)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
TArray<struct FString> ACreativeModeGameState::GetDisableDistanceLevelsOutsideBox(float X, float Y, int W, int L)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
void UCreativeGridLevelsManager::ReceiveDelayUpdateBatchActorInstances(const struct FString& GridName, int AssetId, int MaterialID, bool ReplaceAll)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
