...
{
public:
	class UNiagaraSystem*                              Asset;                                                    // 0x0770(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNiagaraUserRedirectionParameterStore       OverrideParameters;                                       // 0x0778(0x0138) (Edit)
	unsigned char                                      bForceSolo : 1;                                           // 0x08B0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x24];                                      // 0x08B1(0x0024) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x08D5(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x08D5(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x08D5(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x2];                                       // 0x08D6(0x0002) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x08D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x08E8(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x08F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x08F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x08F9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x08FA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x08FB(0x0001) MISSED OFFSET
	int                                                PreviewDetailLevel;                                       // 0x08FC(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	float                                              PreviewLODDistance;                                       // 0x0900(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bEnablePreviewDetailLevel : 1;                            // 0x0904(0x0001) (Edit, Transient)
	unsigned char                                      bEnablePreviewLODDistance : 1;                            // 0x0904(0x0001) (Edit, Transient)
	unsigned char                                      UnknownData03[0x3B];                                      // 0x0905(0x003B) MISSED OFFSET
