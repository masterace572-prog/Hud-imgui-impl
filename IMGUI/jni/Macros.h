...
#define SymDobbyHook_LIB(lib, sym, ptr, org) Tools::Hook((void *) DobbySymbolResolver(OBFUSCATE(lib), OBFUSCATE(sym)), (void *)ptr, (void **)&org)
#define SymDobbyHook_LIB_NO_ORIG(lib, sym, ptr) Tools::Hook((void *) DobbySymbolResolver(OBFUSCATE(lib), OBFUSCATE(sym)), (void *)ptr, (void **)&sub_null)
