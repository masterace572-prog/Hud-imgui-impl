...
{
public:
	struct FScriptMulticastDelegate                    PubgmAutoRunSimulateAction;                               // 0x0110(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference, BlueprintAssignable)
	bool                                               bRoutePointInited;                                        // 0x0120(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0121(0x0007) MISSED OFFSET
	TArray<class AXTPoint*>                            RoutePoints;                                              // 0x0128(0x0010) (ZeroConstructor)
...
{
public:
	TArray<struct FVector>                             DstPointArray;                                            // 0x0110(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                MaxMoveTime;                                              // 0x0120(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxDstStayTime;                                           // 0x0124(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                KillAllTime;                                              // 0x0128(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                StatRecordTime;                                           // 0x012C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	void AutoPickup(class ASTExtraBaseCharacter* Player);
};
...
{
public:
	class UClass*                                      EquipedWeaponClass;                                       // 0x0FA8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      CharacterClass;                                           // 0x0FB0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
