...
// Enum Gameplay.EPlayerStatisticalInfoForPCOB
enum class EPlayerStatisticalInfoForPCOB : uint8_t
{
	EPlayerStatisticalInfoForPCOB__None = 0,
	EPlayerStatisticalInfoForPCOB__KillNumByDriveVehicle = 1,
	EPlayerStatisticalInfoForPCOB__CurSightType = 2,
	EPlayerStatisticalInfoForPCOB__EPlayerStatisticalInfoForPCOB_MAX = 3
};
...
struct FGameModePlayerParams
{
	...
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x0200(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x0210(0x0010) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x0220(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x0224(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x0228(0x0010) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x0238(0x0018)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x0250(0x0018)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x0268(0x0010) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x0278(0x000C)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0284(0x0004) MISSED OFFSET
	TArray<int>                                        audioChat;                                                // 0x0288(0x0010) (ZeroConstructor)
	struct FName                                       CurrentPlayerState;                                       // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       CurrentCharacterState;                                    // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              SyncedTimestamp;                                          // 0x02A8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x02AC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WarmScore;                                                // 0x02B0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AIAllocMarkValue;                                         // 0x02B4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LeaderCount;                                              // 0x02B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x02BC(0x0004) MISSED OFFSET
	uint64_t                                           LastGameLeaderUID;                                        // 0x02C0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   LastGameTeammatesUID;                                     // 0x02C8(0x0010) (ZeroConstructor)
	uint64_t                                           LastGameBattleID;                                         // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              RatingScore;                                              // 0x02E0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDoPlayerUseAutoFollow;                                   // 0x02E4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x02E5(0x0003) MISSED OFFSET
	float                                              MaxRankingScore;                                          // 0x02E8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ObserverFlags;                                            // 0x02EC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           WatchPlayerKey;                                           // 0x02F0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsHawkEyeSpectator;                                      // 0x02F8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x02F9(0x0003) MISSED OFFSET
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x02FC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0300(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlatformGender;                                           // 0x0304(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	int                                                planeAvatarId;                                            // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Nation;                                                   // 0x0310(0x0010) (ZeroConstructor)
	int                                                MatchLabel;                                               // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatColorID;                                        // 0x0324(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                AnchorPlatResID;                                          // 0x0328(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyTeammateSeeAvatar;                                    // 0x032C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x032D(0x0003) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x0330(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CorpsID;                                                  // 0x0338(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CampID;                                                   // 0x0340(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x0348(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0349(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x034A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x5];                                       // 0x034B(0x0005) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0350(0x0010) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0360(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x3];                                       // 0x0361(0x0003) MISSED OFFSET
	int                                                VeteranRecruitIndex;                                      // 0x0364(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MatchStrategyLabel;                                       // 0x0368(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x4];                                       // 0x036C(0x0004) MISSED OFFSET
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0370(0x0010) (ZeroConstructor)
	int                                                LandId;                                                   // 0x0380(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowType;                                               // 0x0384(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           FollowUID;                                                // 0x0388(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x0390(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x0394(0x0004) MISSED OFFSET
	uint64_t                                           LuckmateUID;                                              // 0x0398(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                CollectedEventType;                                       // 0x03A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x03A4(0x0004) MISSED OFFSET
	struct FString                                     GameAPPIDFromDS;                                          // 0x03A8(0x0010) (ZeroConstructor)
	float                                              RealHiddenScore;                                          // 0x03B8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData18[0x4];                                       // 0x03BC(0x0004) MISSED OFFSET
};
...
{
	int8_t                                             AIType;                                                   // 0x03BC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03BD(0x0003) MISSED OFFSET
	uint32_t                                           AILevel;                                                  // 0x03C0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x03C4(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x03C5(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x03C6(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FAttackFlow
{
	...
	float                                              CameraRotationX;                                          // 0x01C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CameraRotationY;                                          // 0x01CC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CameraRotationZ;                                          // 0x01D0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x01D4(0x0004) MISSED OFFSET
};
...
struct FCircleFlow
{
	...
	float                                              TeammateNum;                                              // 0x0274(0x0004) (ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Gameplay.PlayerKillInfoForPCOB
// 0x0040
struct FPlayerKillInfoForPCOB
{
	struct FString                                     CauserName;                                               // 0x0000(0x0010) (ZeroConstructor)
	struct FString                                     VictimName;                                               // 0x0010(0x0010) (ZeroConstructor)
	uint64_t                                           CauserUID;                                                // 0x0020(0x0008) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           VictimUID;                                                // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                Distance;                                                 // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ItemId;                                                   // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ResultHealthStatus;                                       // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ServerWorldTimeSeconds;                                   // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Gameplay.PlayerStatisticalInfoForPCOB
// 0x0010
struct FPlayerStatisticalInfoForPCOB
{
	TArray<int>                                        PlayerStatisticalInfo;                                    // 0x0000(0x0010) (ZeroConstructor)
};
...
struct FPlayerRealTimeAPI
{
	...
	unsigned char                                      CurSightType;                                             // 0x001D(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x001E(0x0002) MISSED OFFSET
};
