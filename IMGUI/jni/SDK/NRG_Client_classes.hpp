...
public:
	...
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00F0(0x03D0)
...
public:
	...
	class UCentauriManager* GetInstance();
...
public:
	...
	class UVoiceSDKInterface*                          VoiceSDK;                                                 // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBugReporter*                                GameBugReporter;                                          // 0x02A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGMLogShare*                                 LogShare;                                                 // 0x02B0(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                MaxUpdateRetryTimes;                                      // 0x02B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x02BC(0x000C) MISSED OFFSET
	class UGDolphinUpdater*                            GDolphin;                                                 // 0x02C8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTranslator*                                 Translator;                                               // 0x02D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UHttpWrapper*                                HttpWrapper;                                              // 0x02D8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGCPufferDownloader*                         GPuffer;                                                  // 0x02E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class ULaggingReporter*                            LaggingReporter;                                          // 0x02E8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x02F0(0x0008) MISSED OFFSET
	class UAsyncTaskDownloader*                        DownloadTask;                                             // 0x02F8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x44];                                      // 0x0300(0x0044) MISSED OFFSET
	bool                                               bUseDolphinUpdateFirst;                                   // 0x0344(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseDolphinUpdate;                                  // 0x0345(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseCDNUpdate;                                      // 0x0346(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDolphinUpdateAfterCDNFailed;                          // 0x0347(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseCDNUpdateAfterDolphinFailed;                          // 0x0348(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableEditorPufferDownload;                              // 0x0349(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsWaitingUpdateStateData;                                // 0x034A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingDolphinUpdate;                                     // 0x034B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingCDNUpdate;                                         // 0x034C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x13];                                      // 0x034D(0x0013) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x0360(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ODPaksPoolSize;                                           // 0x0368(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowend;                                     // 0x036C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ODPaksPoolSizeLowendThreshold;                            // 0x0370(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               ODPaksEnable;                                             // 0x0374(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0x23];                                      // 0x0375(0x0023) MISSED OFFSET
	TScriptInterface<class UClientNetInterface>        ClientNetInterface;                                       // 0x0398(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FName                                       UnrealNetworkStatus;                                      // 0x03A8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x18];                                      // 0x03B0(0x0018) MISSED OFFSET
	float                                              UnrealNetworkConnectingTimer;                             // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x1C];                                      // 0x03CC(0x001C) MISSED OFFSET
	float                                              UnrealNetworkConnectingTime;                              // 0x03E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDynamicCreateLuaManager;                              // 0x03EC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x03ED(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x03F0(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData10[0x4];                                       // 0x0400(0x0004) MISSED OFFSET
	bool                                               bPatchReInitSequence;                                     // 0x0404(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0405(0x0003) MISSED OFFSET
	class ULuaStateWrapper*                            LuaStateWrapper;                                          // 0x0408(0x0008) (ZeroConstructor, IsPlainOldData)
	class ULuaEventBridge*                             LuaEventBridgeInstace;                                    // 0x0410(0x0008) (ZeroConstructor, IsPlainOldData)
	class UBattleWindowMgrLuaUtils*                    LuaBattleWindowMgr;                                       // 0x0418(0x0008) (ZeroConstructor, IsPlainOldData)
	class ULuaBlueprintMgr*                            LuaBlueprintSysMgr;                                       // 0x0420(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0428(0x0008) MISSED OFFSET
	struct FString                                     ScriptBPRelativeDir;                                      // 0x0430(0x0010) (ZeroConstructor, Config)
	struct FString                                     ScriptRelativeDir;                                        // 0x0440(0x0010) (ZeroConstructor, Config)
	struct FString                                     InGameLuaDir;                                             // 0x0450(0x0010) (ZeroConstructor, Config)
	struct FString                                     PreloadLuaFileRelativePath;                               // 0x0460(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             LuaDirList;                                               // 0x0470(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             NoGCPackage;                                              // 0x0480(0x0010) (ZeroConstructor, Config)
	float                                              LuaTickTime;                                              // 0x0490(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCallLuaTick;                                             // 0x0494(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoLoginEnable;                                         // 0x0495(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData13[0x22];                                      // 0x0496(0x0022) MISSED OFFSET
	int                                                PingFirstReportIntervalSecond;                            // 0x04B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PingReportIntervalSecond;                                 // 0x04BC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossSyncIntervalSecond;                                   // 0x04C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PlayerStatusReportIntervalSecond;                         // 0x04C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossArraySyncIntervalSecond;                              // 0x04C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x04CC(0x0004) MISSED OFFSET
	...
	struct FScriptMulticastDelegate                    EnterBattleStageDelegate;                                 // 0x0678(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData19[0xC8];                                      // 0x0688(0x00C8) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x0750(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x0758(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData20[0x4];                                       // 0x075C(0x0004) MISSED OFFSET
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x0760(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x0768(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x0769(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x076A(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x076B(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x076C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x076D(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x076E(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x076F(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x0770(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData21[0x3];                                       // 0x0771(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x0774(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x0778(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData22[0x3];                                       // 0x0779(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x077C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x0780(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x0784(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x0788(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x078C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x0790(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x0794(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x10];                                      // 0x0798(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x07A8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x7];                                       // 0x07A9(0x0007) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x07B0(0x0010) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x07C0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnablePandora;                                           // 0x07C1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x1];                                       // 0x07C2(0x0001) MISSED OFFSET
	bool                                               bEnableJMLog;                                             // 0x07C3(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData26[0xB4];                                      // 0x07C4(0x00B4) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x0878(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x0879(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData27[0x6];                                       // 0x087A(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x0880(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x0888(0x0010) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x0898(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x0899(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData28[0x2];                                       // 0x089A(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x089C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x08A0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x08A8(0x0010) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x08B8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData29[0x8];                                       // 0x08C0(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x08C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x08D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x08E8(0x0010) (ZeroConstructor)
...
public:
	...
	class UTextureRenderTarget2D* MakeWidgetScreenshot(class UWidget* Widget, const struct FVector2D& DrawSize, float Scale);
...
public:
	...
	void UQMCrashPutUserData(const struct FString& Key, const struct FString& Value);
	void UQMCrashPostExceptionFull(int Category, const struct FString& Name, const struct FString& Msg, const struct FString& stack, int dumpNativeType);
	void UQMCrashPostException(int Category, const struct FString& Reason, int dumpNativeType);
	void UQMCrashLog(int Level, const struct FString& Tag, const struct FString& Log, bool needDump);
	...
	void TriggerNativeDump(int DumpCount, double Timespan, int NativeDumpType);
	void TriggerLoginCrashTest(int Type);
	void TriggerLobbyCrashTest(int Type);
	void TriggerBlockAndroidANR();
	void TPerforPlatReport(int Type, const struct FString& ExtraInfo, bool send);
	void TPerforPlatPostLargeValueS(const struct FString& catgory, const struct FString& Key, const struct FString& Value);
	void TPerforPlatMarkTime(int Type);
	void TPerforPlatMarkLevelFin();
	void TPerforPlatDisconnectReport(class UGameFrontendHUD* GameFrontendHUD, int EventId);
	void TPerforPlatDataReport(class UGameFrontendHUD* GameFrontendHUD, int EventId, const struct FString& EventInfo);
	void TMFPSwitchRichTapMode(const struct FString& Mode);
	void TMFPStopRichTap();
	void TMFPStartRichTapWithData(const struct FString& InKey, TMap<struct FString, struct FString> InMapData);
	void TMFPStartRichTap(const struct FString& Filename);
	struct FString TMFPLoadHeFile(const struct FString& StrFilePath);
	struct FString TMFPGetRichTapSupport();
	struct FString TMFPGetRichTapAmplitudeSupport();
	...
	void ShowH5WebView();
	bool ShouldShowRequestPermissionRationale(const struct FString& InPermissionName);
	...
	void SetUserTMFPTapEnableFlag(int EnableFlag);
	...
	void SetUIConfigTMFPTapEnableFlag(int uiEnable);
	void SetUDPPingSequenceLock(int Lock);
	void SetTssNetworkStatus(class UGameFrontendHUD* GameFrontendHUD, int Status);
	void SetTMFPTapWhiteListFlag(int TapWhiteList);
	...
	int SetCentauriZoneID_LuaState();
	void SetCentauriIDC(const struct FString& CentauriIdc);
	...
	bool RequestPermissions(const struct FString& InPermissionName, int reqeusetCode);
	...
	void ReportCrashLogWithFDNum(const struct FString& baseLogInfo);
	...
	void RegisterMemoryWarningHandle(const struct FScriptDelegate& OnMemoryWarning);
	...
	void PostGameStatusToTMFPSMap(class UGameFrontendHUD* GameFrontendHUD, const struct FString& Key, TMap<struct FString, struct FString> mapData);
	...
	void OnPakFileCRCCheck(const struct FString& PakFileName);
	...
	void NoschatShareWithUrlInfo(const struct FString& _descShare, const struct FString& _titleShare, const struct FString& _imgPath, const struct FString& _url, int _shareScene, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void NoschatShareToFriend(const struct FString& mediaId, const struct FString& OpenID, const struct FString& Title, const struct FString& Desc, const struct FString& msdkExtInfo, const struct FString& messageExt, const struct FString& mediaTagName, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void NoschatShare(const struct FString& _descShare, const struct FString& _titleShare, const struct FString& _imgPath, const struct FString& _mediaTagName, const struct FString& _messageExt, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	bool IsPermissionGranted(const struct FString& InPermissionName);
	...
	bool IsInstallBgBgByiTOP(TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	bool IsHarmonyOS();
	...
	void HideH5WebView();
	void HDmpveRemoteConfigStartOnce();
	void HDmpveRemoteConfigSetUrl(const struct FString& InRemoteConfigUrl);
	struct FString HDmpveRemoteConfigGetString(const struct FString& InKey, const struct FString& InDefaultValue);
	int HDmpveRemoteConfigGetInt(const struct FString& InKey, int InDefaultValue);
	bool HDmpveRemoteConfigGetBool(const struct FString& InKey, bool InDefaultValue);
	void HDmpveRemoteConfigClear();
	...
	void GetVoiceSdkReconnectInfo(class UGameFrontendHUD* GameFrontendHUD, TMap<struct FString, struct FString> Data);
	bool GetUserVulkanSetting();
	int GetUserTMFPTapEnableFlag();
	...
	int GetTMFPTapDeviceSupportFlag();
	...
	int GetIMSDKEnv();
	struct FString GetHDmpveInstanceId();
	...
	int GetCentauriPF_LuaState();
	int GetCentauriPayChannel_LuaState();
	...
	void EnterBattle(class UGameFrontendHUD* GameFrontendHUD, const struct FString& HostnameOrIP, uint32_t Port, uint32_t PlayerKey, const struct FString& PlayerName, const struct FString& PacketKey, uint64_t GameID, bool IsObserver, TMap<int, struct FString> AdvConfig, int WaterType, uint32_t WaterUserID, uint32_t ModeID, uint32_t MainModeID, const struct FString& DynamicLevelsOp);
	...
	void EnableVoiceSdkGemReport(class UGameFrontendHUD* GameFrontendHUD, bool Enable);
	...
	void EnableUrlCheck(bool bShouldEnable);
	void EnableTxtCheck();
	bool EnableShaderGroup(const struct FString& GroupName);
	void EnableReportVoiceSdkEvent(class UGameFrontendHUD* GameFrontendHUD, bool InitVoiceSdkComponentReportEnable, bool VoiceSdkJoinRoomReportEnable, bool VoiceSdkQuitRoomReportEnable, bool VoiceSdkJoinLbsRoomReportEnable, bool VoiceSdkQuitLbsRoomReportEnable, bool VoiceSdkOnJoinTeamRoomReportEnable, bool VoiceSdkOnJoinLbsRoomReportEnable);
	...
	void EnableCampVoice(class UGameFrontendHUD* GameFrontendHUD, bool Enable);
	void EnableAutoObjectRefreshStage(bool bEnable);
	void EnableAudioRouteChangedNotify(bool Enable);
	void EnableAkAudioSilenceMode(bool InEnable);
	...
	void CrashSetAppVersion(const struct FString& Version, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void CrashPutUserData(const struct FString& Key, const struct FString& Value, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void CrashPostExceptionFull(int Category, const struct FString& Name, const struct FString& Msg, const struct FString& stack, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void CrashPostException(int Category, const struct FString& Reason, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void CrashLog(int Level, const struct FString& Tag, const struct FString& Log, bool needDump, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	void ConsumeLocalNotificationLaunchApp();
	...
	bool CheckCanUseUrl(const struct FString& URL);
	void CheckBeforeInitPuffer();
	void ChangeLocalizationReleaseTestStatus(class UGameFrontendHUD* GameFrontendHUD, bool Status);
	int CentauriSDKInit_LuaState();
	int CentauriReprovide_LuaState();
	void CentauriPay(const struct FString& productid, int payItem, const struct FString& country, const struct FString& currency);
	void CentauriH5Pay(const struct FString& country);
	void CentauriGoodsPresent(const struct FString& productid, int payItem, const struct FString& price, const struct FString& country, const struct FString& currency, const struct FString& MetaData);
	void CentauriGoods(const struct FString& productid, int payItem, const struct FString& price, const struct FString& country, const struct FString& currency);
	...
	void BqBqShareToFriend(const struct FString& targetUrl, int act, const struct FString& OpenID, const struct FString& Title, const struct FString& Desc, const struct FString& msdkExtInfo, const struct FString& imgUrl, const struct FString& previewText, const struct FString& gameTag, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void BqBqShareH5WithPhoto(const struct FString& _title, const struct FString& _fullURL, int Channel, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void BqBqShare(const struct FString& _imgPath, const struct FString& _descShare, const struct FString& _titleShare, int _shareScene, const struct FString& _imgUrl, const struct FString& _url, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	void BqBqAddFriend(const struct FString& OpenID, const struct FString& Desc, const struct FString& Message, TScriptInterface<class UClientNetInterface>* ClientNetInterface);
	...
	bool AddStreamingLevel(class UWorld* World, const struct FString& SubLevel, bool bShouldBeLoaded, bool bShouldBeVisible, bool bShouldBlockOnLoad);
	...
	void AddAttachDataString(const struct FString& Type, bool bClear, struct FString* strinfo);
};
...
public:
	...
	void PostGameStatusToTMFPIS(int Key, const struct FString& Value);
	int GetDeviceLevel();
};
...
public:
	...
	unsigned char                                      UnknownData04[0x88];                                      // 0x03C8(0x0088) MISSED OFFSET
