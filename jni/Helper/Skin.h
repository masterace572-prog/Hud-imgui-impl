...
void SkinHack()
{
        if (Cheat::Memory::Skin) 
        {
            if (Cheat::localPlayer && Cheat::localPlayer->AvatarComponent2) 
            {
...
                          
                        if (Cheat::localPlayer->WeaponManagerComponent != 0) 
                        {
                            if (Cheat::localPlayer->WeaponManagerComponent->CurrentWeaponReplicated != 0 ) 
                            {
                                int weapowep = Cheat::localPlayer->WeaponManagerComponent->CurrentWeaponReplicated->GetWeaponID();
                                  
                                auto currentTime = std::chrono::steady_clock::now();
                                auto landchud = Cheat::localPlayer->WeaponManagerComponent->CurrentWeaponReplicated->synData;
...
                                                if (weaponid == kar[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1103001191;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == m24[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1103002087;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == m16[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1101002029;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == tommy[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1102004034;
                                                    break;
                                                }
                                            }
                                        }
...
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1102003080;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == m7[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1101008104;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == scar[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1101003195;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == awm[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1103003042;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == m249[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1105001048;
                                                    break;
                                                }
                                            }
                                        }
...
                                                if (weaponid == ump[i]) 
                                                {
                                                    weaponInfo.DefineID.TypeSpecificID = 1102002136;
                                                    break;
                                                }}
                                            } 
                                        }
                                        Cheat::localPlayer->WeaponManagerComponent->CurrentWeaponReplicated->DelayHandleAvatarMeshChanged();
